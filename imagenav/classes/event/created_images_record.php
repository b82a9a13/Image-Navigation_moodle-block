...
class created_images_record extends base {
    ...
    public static function get_name(){
        return 'Created a record in imagenav_images database';
    }
    public function get_description(){
        return "The user with id '".$this->userid."' created a record in the database imagenav_images.";
    }
